...
// In dev mode, this will still work dynamically
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    try {
      ...
      console.warn('Could not set cookie (may be in static export mode):', cookieError)
      // Continue anyway - session token is still returned in response
    }
