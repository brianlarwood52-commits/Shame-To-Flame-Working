...
function VerseOfTheDayCard() {
  ...
  return (
    <div className="group block bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-lg transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border border-white/20 dark:border-gray-700/50 aspect-[3/4] flex flex-col">
      {/* Card Header */}
      <div className="h-28 bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center flex-shrink-0">
        <div className="text-white text-center px-4">
          <div className="text-xl lg:text-2xl font-serif font-bold">Daily Verse</div>
        </div>
      </div>
      
      {/* Card Body */}
      <div className="p-6 flex-1 flex flex-col justify-center items-center text-center overflow-y-auto">
        {loading ? (
          ...
          <>
            <p className="text-gray-700 dark:text-gray-200 italic mb-4 font-serif leading-relaxed">
              "{verse.details.text}"
            </p>
            <p className="text-purple-600 dark:text-purple-400 font-bold uppercase text-xs tracking-wider">
              {verse.details.reference}
            </p>
          </>
        ) : (
          <p className="text-sm text-gray-500">Verse unavailable</p>
        )}
      </div>
    </div>
  )
    ...
    <div className="animate-fade-in">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden z-0">
          <video autoPlay muted loop playsInline preload="auto" className="absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 opacity-60" style={{ pointerEvents: 'none' }}>
            <source src="/shame-to-flame.mp4" type="video/mp4" />
          </video>
          <div className="absolute inset-0 bg-gradient-to-br from-sky-900 via-purple-900 to-flame-900 animate-gradient-shift transition-opacity duration-1000 opacity-90 mix-blend-multiply"></div>
      ...
      <section className="py-20 bg-gradient-to-r from-sky-50/90 to-flame-50/90 dark:from-sky-900/30 dark:to-flame-900/30 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* The 4th slot: Verse of the Day (Restored) */}
            <VerseOfTheDayCard />
